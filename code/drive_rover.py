...
class RoverState():
    def __init__(self):
        ...
        self.stalled = False
        self.stall_timer = time.time()#timer to keep track of how long rover is stuck
        self.stall_timeout = 2.#time limit to prevent rover from getting stalled in 'forward' state
        self.stall_yaw =0#yaw at which rover is stalled
